...
public class ParallelogramTest extends TestCase {
    ...
    public void testMapped() {
        ...
        assertEquals(new IVec2(par.xscl-1,0), par.icoordinates(par.origin.add(par.xdir)));
        assertEquals(new IVec2(0,par.yscl-1), par.icoordinates(par.origin.add(par.ydir)));
        assertEquals(new IVec2(par.xscl-1,par.yscl-1), par.icoordinates(par.origin.add(par.xdir).add(par.ydir)));
